      ...
      <form onSubmit={handleSubmit}>
        ...
        <div className="form-input">
          ...
          <input
            ...
            onChange={(event) =>
              setPayload({ ...payload, name_items: event.target.value })
            }
          />
        </div>
        <div className="form-input">
          ...
          <div className="number-input">
            ...
            <input
              ...
              onChange={(event) =>
                setPayload({
                  ...payload,
                  eligible_items: parseInt(event.target.value),
                })
              }
            />
            <div
          ...
          <div className="number-input">
            <div
              onClick={() =>
                setPayload({
                  ...payload,
                  defective_items: payload.defective_items + 1,
                })
              }
              className="btn"
            >
            ...
            <input
              ...
              onChange={(event) =>
                setPayload({
                  ...payload,
                  defective_items: parseInt(event.target.value),
                })
              }
            />
            <div
        ...
        <div className="form-input">
          ...
          <select
            onChange={(event) =>
              setPayload({ ...payload, magnitudes_id: event.target.value })
            }
            name="magnitudes_id"
            id="magnitudes_id"
          >
        ...
        <div className="form-input">
          ...
          <select
            onChange={(event) =>
              setPayload({ ...payload, categories_id: event.target.value })
            }
            name="category"
            id="category"
          >
